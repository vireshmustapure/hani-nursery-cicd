...
mysqli_query($conn,"INSERT INTO products(name,description,price,category,image,stock)
...
<option value="kunda">All Kunda / Pots</option>
...
<button type="submit" name="save">Add Products</button>
