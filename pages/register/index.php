...
if ($check->num_rows > 0) {
    ...
    exit();
        ...
        if (send_nursery_email($email, 'otp', ['{user_name}' => $name, '{otp_code}' => $otp])) {
...
<?php } ?>
    ...
    <a href="../login/" style="display:block; margin-top:15px; color:#2e7d32; text-decoration:none; font-size:14px; font-weight:600;">Already have an account? Login</a>
</div>
