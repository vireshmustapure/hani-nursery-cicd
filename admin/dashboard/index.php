...
// Low Stock Products
$low_stock = mysqli_query($conn,"SELECT name,stock FROM products WHERE stock <= 10 ORDER BY stock ASC LIMIT 5");
...
for($m=1; $m<=12; $m++){
    ...
    $chart_data[$m] = ($row && $row['total']) ? $row['total'] : 0;
}
...
/* Sidebar styling loaded from sidebar.php */
...
<a href="../products/index.php" class="card-link">
<div class="card">
...
<a href="../orders/index.php" class="card-link">
<div class="card">
<h3>Total Orders</h3>
...
<a href="../users/index.php" class="card-link">
<div class="card">
<h3>Customers</h3>
